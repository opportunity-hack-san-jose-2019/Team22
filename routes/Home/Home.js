...
>>>>>>> Stashed changes
          ...
          <p>
            Once uploaded, press create session and a text message will be sent
            out to all of your attendees to check-in or cancel.{" "}
          </p>
          <div className="numberCircle">3</div>
          <p>
            Keep the page open during your session! Those attendees checked in
            will be kept track of on this page, you can press the match-up
            button whenever you’re ready to assign interviews.
          </p>
        </div>
      </div>
    );
